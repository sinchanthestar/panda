local Logger       = loadstring(game:HttpGet("https://necrocheat.xyz/fish22/logger.lua"))()
...
--// Library
local Noctis = loadstring(game:HttpGet("https://necrocheat.xyz/fish22/lib.lua"))()

-- ===========================
-- LOAD HELPERS & FEATURE MANAGER
-- ===========================
mainLogger:info("Loading Helpers...")
local Helpers = loadstring(game:HttpGet("https://necrocheat.xyz/fish22/helpers.lua"))()

mainLogger:info("Loading FeatureManager...")
local FeatureManager = loadstring(game:HttpGet("https://necrocheat.xyz/fish22/featuremanager.lua"))()
